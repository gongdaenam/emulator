...
def EX_fwd():
    # Forwarding Unit
    if G_MEM.MEM_WB_CTRL['REG_WRITE'] == 1 and G_MEM.MEM_WB['RD'] != 0 and G_MEM.MEM_WB['RD'] == G_MEM.ID_EX['RS'] and (
            G_MEM.EX_MEM['RD'] != G_MEM.ID_EX['RS'] or G_MEM.EX_MEM_CTRL['REG_WRITE'] == 0):
        G_MEM.FWD['FWD_A'] = 1
    ...
    if G_MEM.MEM_WB_CTRL['REG_WRITE'] == 1 and G_MEM.MEM_WB['RD'] != 0 and G_MEM.MEM_WB['RD'] == G_MEM.ID_EX['RT'] and (
            G_MEM.EX_MEM['RD'] != G_MEM.ID_EX['RT'] or G_MEM.EX_MEM_CTRL['REG_WRITE'] == 0):
        G_MEM.FWD['FWD_B'] = 1
...
def ID_hzd():
    ...
    if G_MEM.ID_EX_CTRL['MEM_READ'] == 1 and (
            G_MEM.ID_EX['RT'] == if_id_rs or G_MEM.ID_EX['RT'] == if_id_rt) and G_UTL.data_hzd:
